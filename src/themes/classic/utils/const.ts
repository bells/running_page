...
const CHINESE_LOCATION_INFO_MESSAGE_FIRST = '跑过很多地方，希望以后跑更多地方';
const CHINESE_LOCATION_INFO_MESSAGE_SECOND = 'Keep the faith';
...
export const MAP_TILE_VENDOR: string = 'mapcn';
