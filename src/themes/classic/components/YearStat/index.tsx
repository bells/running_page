...
const addRunToAccumulator = (
  ...
  if (run.week_streak) {
    accumulator.weekStreak = Math.max(accumulator.weekStreak, run.week_streak);
  }
};
...
const finalizeYearStat = (
  ...
  return {
    ...
    weekStreak: accumulator.weekStreak,
  ...
  return (
    <div className="cursor-pointer" onClick={() => onClick(year)}>
      <section {...eventHandlers}>
        ...
        {year === 'Total' && (
          <Stat value={`${summary.weekStreak} week`} description=" Streak" />
        )}
